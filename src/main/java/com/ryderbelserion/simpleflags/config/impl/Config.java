...
public class Config implements SettingsHolder {
    ...
    @Comment("The flag prevent_block_placement allows you to pick blocks that can't be placed.")
    public static final Property<Boolean> block_placement_flag = newProperty("flags.prevent_block_placement-flag", false);
