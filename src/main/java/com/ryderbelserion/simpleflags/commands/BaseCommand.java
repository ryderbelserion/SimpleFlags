package com.ryderbelserion.simpleflags.commands;
...
public class BaseCommand extends PaperCommand {
    ...
    public @NotNull final LiteralCommandNode<CommandSourceStack> literal() {
        final LiteralArgumentBuilder<CommandSourceStack> root = Commands.literal("simpleflags").requires(source -> source.getSender().hasPermission(getPermission()));
